...
helloworld = new Buffer(helloworld); //　性能提高一倍，建议只读buffer，不做额外转换
http.createServer(function(req,res){
	res.writeHead(200);
	res.end(helloworld);
}).listen(8001);
console.log("在命令行中运行：ab -c 200 -t 100 http://127.0.0.1:8001/")
// 通过Apache的ab.exe进行性能测试，发起200个并发客户端，目录C:\Program Files\Java\Apache24\bin*/
